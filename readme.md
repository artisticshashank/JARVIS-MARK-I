# ⚙️JARVIS-MARK-I (1)
### The Ultimate Cross-Platform Personal AI Assistant — By artisticshashank

> 📺 **[Watch the full setup video on YouTube](https://www.youtube.com/@shashanklabs)**
...
```bash
git clone https://github.com/artisticshashank/JARVIS-MARK-I.git
cd JARVIS-MARK-I
...
| Platform | Link |
| --- | --- |
| YouTube | [@shashanklabs](https://www.youtube.com/@shashanklabs) |
| Instagram | [@shashanklab](https://www.instagram.com/shashanklab) |
